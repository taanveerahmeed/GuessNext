...
/**
 * this activity is called via intent when marathon mode is pressed
 */

public class MarathonMode extends AppCompatActivity implements View.OnClickListener {
