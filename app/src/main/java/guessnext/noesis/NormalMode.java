...
/**
 * this activity is called via intent when strat game is pressed
 */
...
public class NormalMode extends AppCompatActivity implements View.OnClickListener {
    ...
    static String userScoreString ,flag,IMEI;
    Animation animation;
    ...
    */
    ...
    //end of sounds initializing
       ...
       if (GetIMEI.sound){
           bg.start();          //playing the heart beat sound
           bg.setLooping(true);
       }
...
// end of onCreate method
    ...
    /**
     * this the defenition of timer that is showed in the game screen
    ...
    public void show () {
        ...
        try {
           ...
           // params.gravity = Gravity.CENTER;
            ...
            if (questionsArray[0].length()<=30) {
                optA.setGravity(Gravity.CENTER);
                //optA.setTextSize(optA.getTextSize() - 2);
                //optA.setLayoutParams(params);
            }
            else {
                optA.setGravity(Gravity.CENTER_VERTICAL);
           ...
           // optA.setText("ggggggggggggggggggggggggggggggggggggggggggggggggggggggggg");
            ...
            resetInterface();
            arrayLengthJson--;
           if (errorCount<5) startTimer();
          //  Toast.makeText(this, errorCount, Toast.LENGTH_LONG).show();
            ...
            // intent.putExtra(flag, "marathonemode");
        ...
        switch (errorCount){
            ...
            case 5:
               ...
               // Toast.makeText(this, "Game Over", Toast.LENGTH_LONG).show();
                bg.stop();
                userScoreString = ""+userScore;
              //  Toast.makeText(this, "turning off", Toast.LENGTH_LONG).show();
                countDownTimer.cancel();
                Intent intent = new Intent(this, GameOver.class);
                //intent.putExtra(IMEI, IMEI);
                //intent.putExtra(userScoreString, score.getText().toString()+"-"+timer.getText().toString());
               ...
               // intent.putExtra(flag, "normal");
                //intent.putExtra(gameTime,timer.getText().toString());
                finish();
